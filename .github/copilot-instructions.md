...
ESP32-based temperature display with cloud database integration (Supabase), OTA updates, and web interface.
...
- Provide visual feedback during uploads (TFT display)
